...
class GateConfig extends RedisHttpSessionConfiguration {
  ...
  @Bean
  VaultService vaultService(OkHttpClient okHttpClient) {
    createClient "vault", VaultService, okHttpClient
  }

  @Bean
  GatekeeperService gatekeeperService(OkHttpClient okHttpClient) {
    createClient "gatekeeper", GatekeeperService, okHttpClient
  }
